...
def navi_only
  navi_only = ''
  navi_only += %Q|#{navi_user.gsub(/<span class="adminmenu"><a href="https:\/\/uwabami.github.io\/index.html">トップ<\/a><\/span>/,'').gsub(/<span class="adminmenu">/, "<div class=\"p0\">").gsub(/<\/span>/,"</div>")}\n|
  navi_only
end
...
def google_search
  gsearch = <<"EOS"
<div>
\t<form method="GET" class="p0 m0" action="https://www.google.com/cse" target="_top">
\t\t<div class="inline-block relative p0 m0 small">
\t\t\t<input name="cx" type="hidden" value="017455171263919107349:3ljlf8jzf3m" />
\t\t\t<input name="ie" type="hidden" value="UTF-8" />
\t\t\t<input class="gsearch" type="search" placeholder="サイト内検索" name="q" required>
\t\t</div>
\t</form>
</div>
EOS
...
def navi
  navi = ''
  navi += %Q| <div class="wrapper">\n|
  navi += %Q| <header class="container top-0 left-0 right-0 z4 fixed">\n|
  navi += %Q|   <nav class="navigation">\n|
  navi += %Q|     <div class="flex items-center justify-between">\n|
  navi += %Q|       <div class="pr1 py1">\n|
  ...
  navi += %Q|         </a>\n|
  navi += %Q|       </div>\n|
  navi += %Q|       <div class="spacer"></div>\n|
  navi += %Q|#{google_search} \n|
  navi += %Q|     </div>\n|
  navi += %Q|   </nav>\n|
  navi += %Q| <div class="breadcrumbs">\n|
  navi += %Q|   <div class="flex items-center justify-between">\n|
  navi += %Q|#{navi_only}\n|
  navi += %Q|   </div>\n|
  navi += %Q| </div>\n|
  ...
  navi += %Q|   <div class="container content">\n|
  navi += %Q|     <h1 class="page-title my2 py0 px0 title-font">#{@conf.html_title}</h1>\n|
  navi
end
